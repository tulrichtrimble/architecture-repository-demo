...
public class AbstractBackstageExample_Trimble extends AbstractExample_Trimble {
    ...
    protected static Workspace createSystemLandscapeWorkspace(Entity[] entities) {
        ...
        Workspace workspace = new Workspace("Landscape", "The system landscape, imported from the Trimble Backstage catalog");
