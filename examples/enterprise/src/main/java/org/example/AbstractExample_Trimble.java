...
class AbstractExample_Trimble {

    protected static String STRUCTURIZR_ONPREMISES_URL = "";
    protected static final String ADMIN_API_KEY_PLAINTEXT = "TYLER_API_KEY";
    protected static final String ADMIN_API_KEY_BCRYPT = "$2a$10$ssgzDJ8Jctt/gA6hzZcn5u3qArT1dn9lA4U0JtIh0pFhQivTikMsu";
    ...
    protected static void attachToStructurizrLiteLocal() throws Exception{
        STRUCTURIZR_ONPREMISES_URL = "http://localhost:8098";
